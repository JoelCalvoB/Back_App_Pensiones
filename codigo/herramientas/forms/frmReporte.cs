...
using pensionesBackend.reportes;
...
namespace SISPE_MIGRACION.codigo.herramientas.forms
{
    public partial class frmReporte : Form
    {
        ...
        public frmReporte(string nombreReporte,string subcarpeta, string tablaDataSet)
        {
            ...
            this.tablas = new pensionesBackend.reportes.tablas();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = string.Format("backend_pensionesmovil.reportes.{0}.rdlc", nombreReporte);
